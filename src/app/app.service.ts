...
export class AppService {
  ...
  public getDetail (authToken:string):Observable<any>{
    const params = new HttpParams()
                  .set('authToken',authToken)
                  
    return this.http.post(`${this.baseUrl}/getDetail`,params);
  }
 ...
 /*  public present(): Observable<any> {
    const params = new HttpParams()
      .set('authToken', Cookie.get('authToken'));
    return this.http.post(`${this.baseUrl}/present`, params);
  } */
